...
import 'package:louzero/ui/page/stub/widgets/stub_counter.dart';
import '../../app_base_scaffold.dart';

class StubViewHome extends GetView<StubController> {
  const StubViewHome({Key? key}) : super(key: key);
