...
class CustomerInfo extends StatelessWidget {
  ...
  final bool fromJob;
  final ExpandableController controller = ExpandableController(initialExpanded: true);
  final expanded = true.obs;

  CustomerInfo(this.customerModel, {this.fromJob = false, Key? key}) : super(key: key);
      ...
      child: Row(
        children: [
          ...
          InkWell(
            onTap: () {
              controller.toggle();
              expanded.value = controller.expanded;
            },
            child: Container(
              width: 40,
              height: 40,
              ...
              child: SvgPicture.asset(
                  "${Constant.imgPrefixPath}/icon-${expanded.value ? 'collapse':'expand'}.svg"),
            ),
          )
        ],
      ),
